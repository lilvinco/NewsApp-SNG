...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR IGNORE INTO `note_table` (`id`,`note`) VALUES (nullif(?, 0),?)";
      }
    ...
    this.__updateAdapterOfNote = new EntityDeletionOrUpdateAdapter<Note>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `note_table` SET `id` = ?,`note` = ? WHERE `id` = ?";
      }
  ...
  public LiveData<List<Note>> getAllNotes() {
    final String _sql = "SELECT * from note_table ORDER BY note ASC";
    ...
    return __db.getInvalidationTracker().createLiveData(new String[]{"note_table"}, false, new Callable<List<Note>>() {
      ...
      public List<Note> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfMNote = CursorUtil.getColumnIndexOrThrow(_cursor, "note");
          final List<Note> _result = new ArrayList<Note>(_cursor.getCount());
          while(_cursor.moveToNext()) {
            final Note _item;
            final String _tmpMNote;
            _tmpMNote = _cursor.getString(_cursorIndexOfMNote);
            _item = new Note(_tmpMNote);
            final int _tmpId;
