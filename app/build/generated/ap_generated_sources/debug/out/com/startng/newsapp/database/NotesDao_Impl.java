  ...
  public NotesDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNotes = new EntityInsertionAdapter<Notes>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, Notes value) {
        ...
        final Long _tmp;
        _tmp = DateConverter.dateToTimestamp(value.getNoteTime());
        if (_tmp == null) {
          stmt.bindNull(2);
        } else {
      ...
      public List<Notes> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            final Date _tmpNoteTime;
            final Long _tmp;
            if (_cursor.isNull(_cursorIndexOfNoteTime)) {
              _tmp = null;
            } else {
              _tmp = _cursor.getLong(_cursorIndexOfNoteTime);
            }
            _tmpNoteTime = DateConverter.fromTimestamp(_tmp);
